    ...
    <div class="flex items-center gap-4 md:gap-8 text-[11px] font-mono tracking-[0.2em] uppercase">
      {#if $route === 'projects'}
        <div class="flex items-center gap-3">
          <button
            onclick={() => navigate('/')}
            class="w-10 h-10 border border-white/10 flex items-center justify-center hover:border-primary/50 transition-colors bg-white/[0.05] backdrop-blur-md rounded-sm"
            aria-label="Go back"
          >
            <ArrowLeft size={18} />
          </button>
